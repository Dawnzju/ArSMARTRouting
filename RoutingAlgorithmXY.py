...
class onlineTimeline: 
    ...
    def removeLinks(self,network,route):
        ...
        for i in range(0,len(route)-1):
            ...
            network.edges[route[i],route[i+1]]["weight"]=network.edges[route[i],route[i+1]]["weight"]+1
        ...
        for i in sendThisTime:
            ...
            for dest in self.taskGraph[str(i)]['out_links'][:]:
                ...
                if(self.outLinks[linkName]["state"]==-1):
                    ...
                    route  = self.computeRouteXY(srcMapto,dstMapto)
                    # print(srcMapto,dstMapto,route)
                   ...
                   # print("dijkstra_path: ",route, "  defaultRoute: ",defaultRoute)
                    ...
                    # if(len(route)==0):
                    #     self.sendMatrix[i]=self.sendMatrix[i]-dest[0][1]
                    ...
                    if(canSend==0):
                        ...
                        self.pendTask.append([i,sendtoi,route])
                        self.nowPri=1000
