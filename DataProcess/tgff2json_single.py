        ...
        def GraphStruct(self,Nodes,Links):
                ...
                for node in Nodes:
                        ...
                        if(t == 0):
                            ...
                            mapto = 0
                        if(t>=self.numPEs):
                            mapto = centreNode + t%self.numPEs


                        dict1 = {'start_time':0,'end_time':0,'exe_time': \
                                int(int(node[1])/100000), \
                                'total_needSend':0, \
                ...
                for link in Links:
                        ...
                        .append([getNum(link[1]), \
                                int(int(link[2])/100),[],[],0,Graph[getNum(link[0])]["mapto"],Graph[getNum(link[1])]["mapto"]])
